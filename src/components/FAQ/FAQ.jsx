          ...
          <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
            <details>
              <summary className="py-2 outline-none cursor-pointer focus:underline">
                Why CS Mentor Course?
              </summary>
              <div className="px-4 pb-4">
                <p>
                  CS Mentor will explain cs related course with easy and
                  simplest way.
                </p>
              </div>
            </details>
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  Our instructor have a wide range of knowledge about cs
                  programming courses. You will get best output by enrolling our
                  courses. Our teaching methods are beginner friendly.
                </p>
              </div>
            </details>
            <details>
              <summary className="py-2 outline-none cursor-pointer focus:underline">
                Why choose CS Mentor?
              </summary>
              <div className="px-4 pb-4 space-y-2">
                <p>You will get our all facilities by joining our courses.</p>
              </div>
            </details>
          </div>
        </div>
